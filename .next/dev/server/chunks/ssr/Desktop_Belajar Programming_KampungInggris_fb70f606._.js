...
"[project]/Desktop/Belajar Programming/KampungInggris/src/app/(tutor)/tutor/schedules/actions.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"60098f57e216003b2bb2c52e20d99106dccc0dc5ec":"takeOverSession"},"",""] */ __turbopack_context__.s([
    "takeOverSession",
    ()=>takeOverSession
]);
...
;
;
async function takeOverSession(sessionId, currentTutorId) {
    try {
        if (!sessionId || !currentTutorId) {
            return {
                error: "Session ID and Tutor ID are required."
            };
        }
        ...
        if (session.isCompleted) {
            return {
                error: "Cannot take over a completed session."
            };
        }
        if (session._count.attendances > 0) {
            return {
                error: "Cannot take over a session that already has attendance records."
            };
        }
        if (session.tutorId === currentTutorId) {
            return {
                error: "You are already the assigned tutor for this session."
            };
        }
        ...
        return {
            error: error.message || "Failed to take over session."
        };
    }
}
;
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Belajar__Programming$2f$KampungInggris$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(takeOverSession, "60098f57e216003b2bb2c52e20d99106dccc0dc5ec", null);
}),
"[project]/Desktop/Belajar Programming/KampungInggris/.next-internal/server/app/(tutor)/tutor/schedules/page/actions.js { ACTIONS_MODULE0 => \"[project]/Desktop/Belajar Programming/KampungInggris/src/app/(tutor)/tutor/schedules/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Belajar__Programming$2f$KampungInggris$2f$src$2f$app$2f28$tutor$292f$tutor$2f$schedules$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Belajar Programming/KampungInggris/src/app/(tutor)/tutor/schedules/actions.ts [app-rsc] (ecmascript)");
;
}),
"[project]/Desktop/Belajar Programming/KampungInggris/.next-internal/server/app/(tutor)/tutor/schedules/page/actions.js { ACTIONS_MODULE0 => \"[project]/Desktop/Belajar Programming/KampungInggris/src/app/(tutor)/tutor/schedules/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "60098f57e216003b2bb2c52e20d99106dccc0dc5ec",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Belajar__Programming$2f$KampungInggris$2f$src$2f$app$2f28$tutor$292f$tutor$2f$schedules$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["takeOverSession"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Belajar__Programming$2f$KampungInggris$2f2e$next$2d$internal$2f$server$2f$app$2f28$tutor$292f$tutor$2f$schedules$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$Desktop$2f$Belajar__Programming$2f$KampungInggris$2f$src$2f$app$2f28$tutor$292f$tutor$2f$schedules$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/Desktop/Belajar Programming/KampungInggris/.next-internal/server/app/(tutor)/tutor/schedules/page/actions.js { ACTIONS_MODULE0 => "[project]/Desktop/Belajar Programming/KampungInggris/src/app/(tutor)/tutor/schedules/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Belajar__Programming$2f$KampungInggris$2f$src$2f$app$2f28$tutor$292f$tutor$2f$schedules$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Belajar Programming/KampungInggris/src/app/(tutor)/tutor/schedules/actions.ts [app-rsc] (ecmascript)");
}),
];

//# sourceMappingURL=Desktop_Belajar%20Programming_KampungInggris_fb70f606._.js.map