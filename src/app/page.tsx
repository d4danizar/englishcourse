...
import { ArrowRight, BookOpen, Users, Award, Star, CheckSquare } from "lucide-react";
...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans selection:bg-gray-900 selection:text-white">
      ...
      <header className="fixed top-0 w-full bg-white/90 backdrop-blur-md z-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            <span className="text-2xl font-black tracking-tighter text-black uppercase decoration-2 underline-offset-4 group-hover:underline">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/login"
              className="px-5 py-2.5 text-sm font-bold text-black border-2 border-black hover:bg-gray-50 transition-colors hidden sm:block"
            >
              Sign In Siswa
            </Link>
            <Link
      ...
      {/* 2. HERO SECTION */}
      <section className="pt-40 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        <div className="flex-1 text-center lg:text-left">
          <h1 className="text-5xl md:text-7xl font-black tracking-tight text-black leading-[1.1] mb-6">
      ...
      {/* 3. VALUE PROPOSITION */}
      <section id="keunggulan" className="py-24 bg-gray-50 border-y border-gray-200">
      ...
      {/* 4. FEATURED PROGRAMS */}
      <section id="program" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            <h2 className="text-4xl md:text-5xl font-black text-black tracking-tight mb-4">Pilih Jenjangmu.</h2>
            <p className="text-lg text-gray-500 max-w-xl font-medium">Program unggulan dengan jadwal fleksibel yang siap membantu Anda dari dasar hingga mahir.</p>
          </div>
          <Link href="#semua-program" className="text-black font-bold border-b-2 border-black pb-1 hover:text-gray-500 hover:border-gray-500 transition-colors">Lihat Semua Program</Link>
        </div>
      ...
      <section id="testimoni" className="py-24 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-5xl font-black text-center mb-16 tracking-tight">Kisah Alumni Kece</h2>
      ...
      {/* 6. FINAL CTA */}
      <section id="daftar" className="py-32 bg-gray-100 text-center px-4">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl md:text-6xl font-black text-black tracking-tight mb-8">
          ...
          <Link
            ...
            target="_blank"
            className="inline-flex px-10 py-5 text-lg font-black text-white bg-black hover:scale-105 transition-transform shadow-2xl shadow-black/20"
          >
      ...
      <footer className="py-12 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4 flex flex-col md:flex-row justify-between items-center gap-6">
