        ...
        <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 w-full lg:w-auto">
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <input 
              ...
              className="flex-1 sm:flex-none p-2 border border-slate-300 rounded-xl bg-white text-sm font-semibold text-slate-700 outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer min-w-0"
            />
          ...
          <div className="grid grid-cols-1 sm:flex sm:flex-wrap items-center gap-2 w-full sm:w-auto">
            <button 
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 border border-slate-300 text-sm font-bold text-slate-700 bg-white rounded-xl hover:bg-slate-50 transition-colors shadow-sm disabled:opacity-50"
            >
            ...
            <button 
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-bold text-white bg-emerald-600 rounded-xl hover:bg-emerald-700 transition-colors shadow-sm"
            >
              <Plus className="w-4 h-4 shrink-0" /> Catat Pemasukan
            </button>

            <button 
              onClick={() => setIsModalOpen(true)}
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-bold text-slate-700 bg-slate-100 rounded-xl hover:bg-slate-200 transition-colors shadow-sm border border-slate-200"
            >
              <Plus className="w-4 h-4 shrink-0" /> Catat Pengeluaran
            </button>
          </div>
        </div>
      </div>
